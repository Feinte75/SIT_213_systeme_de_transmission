...
public class EmetteurNumeriqueAnalogique extends Transmetteur<Boolean, Float>
	...
	/**
	 * Codage retour à zéro. Signal à min ou max pendant 1/2 symbole puis 0
	 * ensuite
	 */
	...
	/**
	 * Codage Non Retour à Zéro. Signal à max pour un "1" et à min pour un "0"
	 */
	...
	/**
	 * Codage Non Retour à Zéro Triangulaire. Pour un "1", pente montante de min
	 * à max durant 1/3 de la période, plateau à max pendant 1 autre tier puis
	 * pente descendante jusqu'à min pendant le dernier tier de la période
	 */
